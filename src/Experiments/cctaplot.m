...
load('May_ex\NPLV_unconstrained\eta');
load('May_ex\NPLV_unconstrained\eta_ref');
load('May_ex\NPLV_unconstrained\nu');
load('May_ex\NPLV_unconstrained\alpha');
load('May_ex\NPLV_unconstrained\tau');
load('May_ex\NPLV_unconstrained\tau_dot');
...
load('May_ex\NPLV_mrs\eta');
load('May_ex\NPLV_mrs\eta_t');
load('May_ex\NPLV_mrs\nu');
load('May_ex\NPLV_mrs\alpha');
load('May_ex\NPLV_mrs\tau');
load('May_ex\NPLV_mrs\tau_dot');
eta_t=eta_d;
