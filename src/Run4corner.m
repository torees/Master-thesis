...
posnoise = [0.001 0.001 0.009]*noise;
velnoise=[0.002 0.002 0.01]*noisev;
sim('NPNV_CSAD_model');
...
pathtrackplotter_mclab(eta1, 10, 3000,'r', '--r' )
h = zeros(3, 1);
...
x = subplot(3,1,1);
hold on
plot(eta_t(:,1),'--k','Linewidth',1.5)
plot(eta_t_NPNV(:,1),'-.g','Linewidth',1.5)
plot(eta_NPNV(:,1),'b','Linewidth',1.5)
plot(eta_AB(:,1),'-.r','Linewidth',1.5)
grid on
y = subplot(3,1,2);
hold on
